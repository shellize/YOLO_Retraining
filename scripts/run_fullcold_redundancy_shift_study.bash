...
REDUNDANCY_ROOT="$PROJECT_ROOT/data_analyse/dataset_redundancy/results/$STUDY_ID"
RANDOM_SPLIT_ROOT="$PROJECT_ROOT/data_analyse/custom_dataset/results/${STUDY_ID}_random_frame_s${RANDOM_SPLIT_SEED}"
