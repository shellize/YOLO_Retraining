...
directly.  This bridge rewrites the output location so the active launcher also
keeps the generator and generated results together, then removes itself after a
successful handoff.
"""
