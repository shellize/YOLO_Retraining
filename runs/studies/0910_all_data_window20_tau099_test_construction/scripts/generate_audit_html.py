...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    post_summary = {
        ...
        "manual_review_export": "global_post_dedup_manual_review.csv (downloaded by the browser)",
    }
