...
SOURCE_LAYOUT = PROJECT_ROOT / "configs" / "data" / "learning_curve" / "balance_2batch_ordered.yaml"
SOURCE_EMBEDDINGS = (
    PROJECT_ROOT
    / "data_analyse"
    / "dataset_redundancy"
...
def build_variant(
    *,
    ...
    variant_dir = STUDY_ROOT / "variants" / variant_name
...
def main() -> int:
    ...
    summary_path = STUDY_ROOT / "manifest_summary.json"
