...
CONFIGS=(
  "$STUDY_ROOT/configs/dedup_tau_0p990.yaml"
  "$STUDY_ROOT/configs/dedup_tau_0p960_mixed_release_drop_pure_background.yaml"
)
OUTPUT_NAMES=(
...
for experiment in "${EXPERIMENTS[@]}"; do
  layout="$STUDY_ROOT/variants/$experiment/layout.yaml"
